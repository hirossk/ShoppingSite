...
//     db.run(`INSERT INTO item (name, price, image, stock, description) VALUES 
//           ('ギター',       30000, 'guitar',   10, '初心者にもやさしいアコースティックギター。軽くて弾きやすく、はじめの1本にぴったりです。')`);
//     db.run(`INSERT INTO item (name, price, image, stock, description) VALUES 
//           ('エレクトーン', 300000, 'electone', 10, '足鍵盤までついた本格エレクトーン。1台でバンドのような演奏が楽しめる上位モデルです。')`);
//     db.run(`INSERT INTO item (name, price, image, stock, description) VALUES 
//           ('キーボード',   48000, 'midi',     10, '61鍵のスタンダードなキーボード。たくさんの音色が入っていて、練習にも演奏にも使えます。')`);
